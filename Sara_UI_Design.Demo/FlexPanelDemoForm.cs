...
namespace Sara_UI_Design.Demo {
    internal sealed class FlexPanelDemoForm:Form {
        public FlexPanelDemoForm() {
            ...
            Button iconLibraryButton = CreateActionButton("Probar iconos");
            ...
            iconLibraryButton.Click += (_, _) => {
                using IconLibraryDemoForm demoForm = new IconLibraryDemoForm();
                demoForm.ShowDialog(this);
            };
            ...
            actionsPanel.Controls.Add(iconLibraryButton);
